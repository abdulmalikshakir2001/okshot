...
const TimeLine: React.FC<VideoEditorProps> = ({ videoUrl, subtitles, onCutVideo, videoRef }) => {
  ...
  return (
    ...
    <div onMouseUp={handleMouseUp} onMouseLeave={handleMouseLeave} onMouseMove={handleMouseMove} className='overflow-x-auto h-[230px] w-full'>
      ...
      {!loading ? (
        ...
        <div ref={timelineRef} className='relative h-[40px] mt-10 border bg-gray-300 rounded-xl' style={{ width: `${frames.length * 120}px` }}>
          <div
            style={{
